...
class TT100K2COCO:
    ...
    def coco_json2yolo_txt(self, class_json, path):
        ...
        json_file = os.path.join(annotations_path, '%s.json' % class_json)  # COCO Object Instance 类型的标注
        # ana_txt_save_path = 'D:/jinxData/TT100K/data/dataset/annotations/train'  # 保存的路径
        ana_txt_save_path = os.path.join(annotations_path, class_json)  # 保存的路径
    ...
    def divide_TrainValTest(self, source, target):
        ...
        for root, dirs, files in os.walk(source):
            for file in files:
                ...
                if (file_name == 'classes' or file_name == 'test' or file_name == 'val' or file_name == 'train'):
                    continue
                image_path = os.path.join(file_name + '.jpg')
                # print(source)
                if 'train' in source:
                    shutil.copyfile('E:/code/tengine-lite-yolov5s-tt100k/tt100k_2021/image_reparation/'
...
if __name__ == '__main__':
    # 按顺序执行
    parent_path = "E:/code/tengine-lite-yolov5s-tt100k/tt100k_2021/"
    tt100k = TT100K2COCO(parent_path)
    # tt100k.class_statistics()
    # tt100k.original_datasets2object_datasets_re()

    # annotations_path = "E:/code/tengine-lite-yolov5s-tt100k/tt100k_2021/annotations/"
    # tt100k.coco_json2yolo_txt('train', annotations_path)  # 分别运行 test， val， train
    # tt100k.coco_json2yolo_txt('test', annotations_path)  # 分别运行 test， val， train
    # tt100k.coco_json2yolo_txt('val', annotations_path)  # 分别运行 test， val， train

    # tt100k.divide_TrainValTest('E:/code/tengine-lite-yolov5s-tt100k/tt100k_2021/annotations/test',
    #                             'E:/code/tengine-lite-yolov5s-tt100k/precess_data')
    # tt100k.divide_TrainValTest('E:/code/tengine-lite-yolov5s-tt100k/tt100k_2021/annotations/train',
    #                             'E:/code/tengine-lite-yolov5s-tt100k/precess_data')
    # tt100k.divide_TrainValTest('E:/code/tengine-lite-yolov5s-tt100k/tt100k_2021/annotations/val',
    #                             'E:/code/tengine-lite-yolov5s-tt100k/precess_data')
